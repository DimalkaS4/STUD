...
(function(){
  ...
  const initAnimations = () => {
    if (typeof gsap === 'undefined') {
      ...
      // Fallback for simple reveal if GSAP fails
    ...
    revealElements.forEach(el => {
      // Skip hero elements as they are handled above
    ...
    // Micro-interaction: Magnetic-like effect on cards (subtle parallax)
  ...
  document.addEventListener('DOMContentLoaded', ()=>{
    themeToggle();
    initAnimations(); // Replaced initReveal
    initNav();
    colorSwap();
    initSizeGuide();
  })
